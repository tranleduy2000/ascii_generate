...
void Java_com_duy_acsiigenerator_image_asciicam_AsciiConverter_getAsciiValuesBWNative(JNIEnv* env, jobject thiz,
...
void Java_com_duy_acsiigenerator_image_asciicam_AsciiConverter_getAsciiValuesWithColorNative(JNIEnv* env, jobject thiz,
        jbyteArray jdata, jint imageWidth, jint imageHeight, 
 ...
 */
void Java_com_duy_acsiigenerator_image_asciicam_AsciiRenderer_fillPixelsInRowNative(
